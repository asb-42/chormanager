...
6. [Termine und Verfügbarkeit](#6-termine-und-verfügbarkeit)
...
Ein Projekt fasst alles zusammen, was zu einer Produktion gehört.

### Neues Projekt erstellen

1. Tab **Projekte** öffnen
2. Toolbar: **Hinzufügen** klicken
3. Namen eingeben (z.B. "Hoffmann OKO 2026")
4. **Speichern**
...
2. Toolbar: **Bearbeiten**
3. Änderungen vornehmen
4. **Speichern**

### Filterung nach Stimmgruppe

Oben im Tab: Stimmgruppen-Filter auswählen.
...
4. Sänger auswählen (Checkbox-Liste)
5. **Speichern**

### Als aktiv setzen

Die aktive Besetzung wird an anderen Stellen verwendet:
- Toolbar: **Als aktiv setzen**
...
3. Felder ausfüllen:
   ...
   - **Typ**: Generalprobe, Orchesterprobe, Auftritt, Konzert
   - **Datum/Zeit**
   - **Ort**
4. **Speichern**
...
3. Für jeden Sänger Status wählen:
   - ✓ Verfügbar / Zusage
   - ✗ Nicht verfügbar / Absage
   - ○ Keine Rückmeldung
...
3. Felder ausfüllen:
   ...
   - **Land**: Nationalität
   - **Verlag**: Notenverlag
   - **Besetzung**: z.B. "Gemischter Chor"
   - **Standort**: Wo sind die Noten?
   - **Programm**: Verweis auf ein Konzertprogramm

### Programm verknüpfen

Das Feld **Programm** enthält eine Dropdown-Liste aller Konzertprogramme.
...
1. Menü: **Extras → Einstellungen**
2. **Datenpfad**: Neuen Ordner wählen

### Sprache

Deutsche Benutzeroberfläche (Standard).
...
Falls Fehler: Python 3.8+ und PyQt6 erforderlich.

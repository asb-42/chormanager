...
from ...domain.repository import EventRepository, SingerRepository, AvailabilityRepository, ProjectRepository
...
class EventsTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        avail_button = QPushButton("Verfügbarkeit")
        avail_button.clicked.connect(self._manage_availability)
        toolbar.addWidget(avail_button)
        
        select_button = QPushButton("Ausgewählten Termin setzen")
        select_button.clicked.connect(self._set_selected_event)
        ...
        self.table.setHorizontalHeaderLabels(["Datum", "Name", "Typ", "Projekt", "Verbindl. Zusagen", "Vorbehalt"])
    ...
    def _manage_availability(self):
        ...
        if current_row < 0:
            QMessageBox.information(self, "Information", "Bitte wählen Sie einen Termin aus")
            return
